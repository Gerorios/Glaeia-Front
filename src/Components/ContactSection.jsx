      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input 
              type="text" 
              id="name" 
              className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-neutral"
          ...
          <div className="flex justify-center">
            <button className="bg-primary text-white px-6 py-2 rounded-lg hover:bg-neutral transition duration-300 w-full sm:w-auto">
              Enviar
            </button>
          </div>
        </div>
        ...
        <div className="text-base sm:text-lg text-gray-900 space-y-6">
          <div className="flex items-start space-x-3">
            <FaMapMarkerAlt className="text-neutral text-xl sm:text-2xl flex-shrink-0" />
